...
def prompt(options, allow_inventory=True):
    ...
    Команды: i — инвентарь, j — журнал, h — помощь, q — выход.
    """
    while True:
        print()
        ...
        if allow_inventory:
            print('  ───')
            print('  i — инвентарь, j — журнал, h — помощь, q — выход')
        ...
        if allow_inventory and raw == 'h':
            ...
            print('  Игра сохраняется автоматически — просто не закрывайте окно.')
            continue
